...
#             yn = raw_input(Fore.WHITE + "ws due ADB cok?lk grong install? "+Fore.GREEN + "Y"+Fore.WHITE+"/"+Fore.RED+"N "+Fore.WHITE)
#             if yn == "n":
...
logo_design_1 = ('''
  ...
  / /_/ / __ \/ __ \/ __ \/ _ \\__ \/ __ \/ / __ \/ / __/  \033[0m CODED by BL4NK \033[92m
...
logo_design_2 = Fore.GREEN + '''                                             
 ...
 .;'  ,;'             `;,  `;,   {0}PhoneSploit
.;'  ,;'  ,;'     `;,  `;,  `;,
::   ::   :   {1}( ){0}   :   ::   ::  \033[0m Coded by BL4NK \033[92m 
':.  ':.  ':. {1}/_\{0} ,:'  ,:'  ,:'
 ':.  ':.    {1}/___\{0}    ,:'  ,:'   
  ':.       {1}/_____\{0}      ,:'
           {1}/       \\{0}
...
\033[92m
  ...
  \033[92m..  yyyyyyyyyyyyyyyyyyyy  ..              \033[0m Dancuk time :) \033[92m
